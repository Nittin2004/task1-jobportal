export const preparationData = {
  aptitude: {
    ...
    description: "Master quantitative, logical, and verbal reasoning concepts frequently asked in aptitude rounds.",
    icon: "🔢",
    questions: [
      {
        id: "apt-1",
...
1. **Understand the Speed Conversion:**
   The speed is given in km/hr and the time in seconds. We need to convert speed to meters per second (m/s).
   $$\\text{Speed in m/s} = \\text{Speed in km/hr} \\times \\frac{5}{18}$$
   $$\\text{Speed} = 60 \\times \\frac{5}{18} = \\frac{300}{18} = \\frac{50}{3} \\text{ m/s} \\approx 16.67 \\text{ m/s}$$

2. **Apply the Distance Formula:**
   Since the pole has negligible length, the distance traveled by the train to cross the pole is equal to the length of the train itself.
   $$\\text{Distance (Length of Train)} = \\text{Speed} \\times \\text{Time}$$
   $$\\text{Length of Train} = \\frac{50}{3} \\times 9$$
   $$\\text{Length of Train} = 50 \\times 3 = 150 \\text{ meters}$$
...
1. **Calculate Individual One-Day Work:**
   - A's 1-day work = $\\frac{1}{20}$
   - B's 1-day work = $\\frac{1}{30}$
   - C's 1-day work = $\\frac{1}{60}$

2. **Formulate the Work Cycle:**
   The work pattern is:
   - Day 1: A works alone. Work done = $\\frac{1}{20}$
   - Day 2: A works alone. Work done = $\\frac{1}{20}$
   - Day 3: A is assisted by B and C (A, B, C work together).
     Work done on Day 3 = $\\frac{1}{20} + \\frac{1}{30} + \\frac{1}{60} = \\frac{3 + 2 + 1}{60} = \\frac{6}{60} = \\frac{1}{10}$

3. **Calculate Work Done in a 3-Day Cycle:**
   $$\\text{Work in 3 days} = \\text{Day 1 work} + \\text{Day 2 work} + \\text{Day 3 work}$$
   $$\\text{Work in 3 days} = \\frac{1}{20} + \\frac{1}{20} + \\frac{1}{10} = \\frac{1}{10} + \\frac{1}{10} = \\frac{2}{10} = \\frac{1}{5}$$

4. **Determine Total Cycles Needed:**
   Since $\\frac{1}{5}$ of the work is completed in 3 days:
   $$\\text{Total time to complete 1 (whole) work} = 3 \\times 5 = 15 \\text{ days}$$

**Answer:** A will complete the work in **15 days**.`
      },
      {
        id: "apt-3",
        title: "Averages Replacement Problem",
        difficulty: "Medium",
        tag: "Averages",
...
1. **Analyze the Change in Total Weight:**
   - Number of persons = $8$
   - Increase in average weight = $2.5\\text{ kg}$
   - Total increase in weight of the group = $\\text{Number of persons} \\times \\text{Increase in average}$
   $$\\text{Total Increase} = 8 \\times 2.5 = 20 \\text{ kg}$$

2. **Determine the New Person's Weight:**
   Since the replacement increased the total weight of the group by 20 kg, the incoming person must weigh 20 kg more than the person who left.
   $$\\text{Weight of new person} = \\text{Weight of replaced person} + \\text{Total increase}$$
   $$\\text{Weight of new person} = 65 \\text{ kg} + 20 \\text{ kg} = 85 \\text{ kg}$$

**Answer:** The weight of the new person is **85 kg**.`
      },
      {
        id: "apt-4",
        ...
        difficulty: "Easy",
        tag: "Interest",
        question: "A sum of money at simple interest amounts to $815 in 3 years and to $854 in 4 years. Find the principal sum.",
        explanation: `### Step-by-Step Solution:

1. **Find Interest Earned in 1 Year:**
   - Amount in 4 years = $854
   - Amount in 3 years = $815
   Since Simple Interest (S.I.) remains constant every year:
   $$\\text{S.I. for 1 year} = \\text{Amount in 4 yrs} - \\text{Amount in 3 yrs}$$
   $$\\text{S.I. for 1 year} = 854 - 815 = \\$39$$

2. **Find Interest Earned in 3 Years:**
   $$\\text{S.I. for 3 years} = 39 \\times 3 = \\$117$$

3. **Calculate the Principal (P):**
   $$\\text{Principal} = \\text{Amount in 3 years} - \\text{S.I. for 3 years}$$
   $$\\text{Principal} = 815 - 117 = \\$698$$

**Answer:** The principal sum is **$698**.`
      },
      {
        id: "apt-5",
        title: "Profit, Loss & Markups",
        difficulty: "Medium",
        tag: "Profit & Loss",
        question: "A shopkeeper sells an article at a discount of 10% on the marked price and still gains a profit of 20%. If its marked price is $800, what is the cost price?",
        explanation: `### Step-by-Step Solution:

1. **Calculate the Selling Price (SP):**
   - Marked Price (MP) = $800
   - Discount = 10%
   $$\\text{Discount Amount} = 10\\% \\text{ of } 800 = \\$80$$
   $$\\text{SP} = \\text{MP} - \\text{Discount} = 800 - 80 = \\$720$$

2. **Calculate the Cost Price (CP) using Profit Percentage:**
   - Profit = 20%
   - We know that: $\\text{SP} = \\text{CP} \\times (1 + \\frac{\\text{Profit}\\%}{100})$
   $$720 = \\text{CP} \\times (1 + 0.20) = \\text{CP} \\times 1.2$$
   $$\\text{CP} = \\frac{720}{1.2} = \\frac{7200}{12} = \\$600$$

**Answer:** The cost price of the article is **$600**.`
      },
      {
        id: "apt-6",
        title: "Probability of Marbles Selection",
        difficulty: "Medium",
        tag: "Probability",
        question: "A box contains 5 green, 6 red, and 4 yellow marbles. If 3 marbles are drawn at random, what is the probability that they are all of green color?",
        explanation: `### Step-by-Step Solution:

1. **Calculate the Total Number of Marbles:**
   $$\\text{Total Marbles} = 5 \\text{ Green} + 6 \\text{ Red} + 4 \\text{ Yellow} = 15 \\text{ marbles}$$

2. **Find Total Ways to Draw 3 Marbles out of 15 ($n(S)$):**
   $$n(S) = \\binom{15}{3} = \\frac{15 \\times 14 \\times 13}{3 \\times 2 \\times 1} = 5 \\times 7 \\times 13 = 455$$

3. **Find Favorable Ways to Draw 3 Green Marbles out of 5 Green ($n(E)$):**
   $$n(E) = \\binom{5}{3} = \\frac{5 \\times 4 \\times 3}{3 \\times 2 \\times 1} = 10$$

4. **Calculate Probability ($P(E)$):**
   $$P(E) = \\frac{n(E)}{n(S)} = \\frac{10}{455} = \\frac{2}{91}$$

**Answer:** The probability is **2/91** (approx. 0.022 or 2.2%).`
      }
    ]
  },
  dsa: {
